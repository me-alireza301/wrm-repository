package pe.com.spring.ws.example.serviceTest;

import java.util.List;
import pe.com.spring.ws.example.configTest.AbstractUnitTest;
...
public class PersonServiceTest extends AbstractUnitTest {
	...
	public void testDeletePerson() {
		...
		Person person = this.personService.findPersonById(4L);
		System.out.println("deletePerson = " + person.toString());
		this.personService.deletePerson(person);
		Person dPerson = this.personService.findPersonById(4L);
		assertNull(dPerson);
	}
